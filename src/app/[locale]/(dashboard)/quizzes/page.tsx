    ...
    <div className="space-y-8">
            ...
            >
              ...
              <div className="mt-6 flex items-center justify-between border-t border-slate-900/60 pt-4">
                <Link
                  ...
                  className="inline-flex items-center gap-1.5 rounded-lg bg-slate-950/60 px-3.5 py-2 text-xs font-semibold text-blue-400 hover:bg-blue-600 hover:text-white transition"
                >
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/70 p-4 backdrop-blur-sm">
          <div className="relative w-full max-w-2xl rounded-3xl border border-slate-800 bg-slate-900 p-8 shadow-2xl space-y-6 max-h-[90vh] overflow-y-auto">
            {/* Modal header */}
