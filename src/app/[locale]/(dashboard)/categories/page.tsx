  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-3xl font-extrabold tracking-tight text-white">Quiz Categories</h1>
          <p className="mt-2 text-slate-400">
            Define hierarchical subjects or test categories (up to 10 levels deep) to organize quizzes and control access.
          </p>
        </div>
      ...
      {isLoading ? (
            ...
            <table className="w-full text-left text-sm border-collapse">
              <thead>
                <tr className="border-b border-slate-900 text-xs font-semibold uppercase tracking-wider text-slate-500 bg-slate-950/20">
                  ...
                  <th className="py-4 px-6 text-center">Nesting</th>
                    ...
                    return (
                      <tr key={category.id} className="hover:bg-slate-900/20 transition">
                        ...
                        <td className="py-4 px-6 text-center text-xs font-semibold text-slate-500">
                          Depth: <span className="text-white">{category.depth}</span>
                        </td>
        ...
        <div className="rounded-2xl border border-dashed border-slate-800 p-12 text-center text-slate-500 bg-slate-900/5 backdrop-blur-xl">
          ...
          <h3 className="font-bold text-lg text-white">No categories found</h3>
          <p className="mt-1 text-sm">Add subjects or nested modules to start organizing your quizzes.</p>
        </div>
      )}
          ...
          <div className="w-[95%] max-w-md rounded-2xl border border-slate-800 bg-slate-900 p-6 sm:p-8 shadow-2xl space-y-6 max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                {errors.parent_id && <p className="text-xs text-rose-400">{errors.parent_id.message}</p>}
              </div>
          ...
          <div className="w-[95%] max-w-lg rounded-2xl border border-slate-800 bg-slate-900 p-6 sm:p-8 shadow-2xl space-y-6 max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between text-xs text-slate-400">
                <span>Upload a CSV file containing categories hierarchy structure.</span>
                <a
              ...
              >
                ...
                <p className="text-sm font-semibold text-slate-200">
                  {importFile ? importFile.name : 'Click to upload category CSV'}
                </p>
                    ...
                    <table className="w-full text-left">
                      <thead>
                        <tr className="bg-slate-950/60 border-b border-slate-850 text-slate-400">
                          ...
                          <th className="p-2.5">Parent Slug</th>
